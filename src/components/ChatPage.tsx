          ...
          <AnimatePresence initial={false}>
            {messages.map((msg) => {
              ...
              return (
                ...
                >
                  <div onPointerDown={() => handlePointerDown(msg)} onPointerUp={handlePointerUp} onPointerLeave={handlePointerUp} onContextMenu={(e) => { /* prevent context menu if long pressing */ if (pressTimerRef.current) clearTimeout(pressTimerRef.current); }} className={`relative px-5 py-3.5 rounded-[20px] text-[15px] transition-all duration-300 h-fit w-fit min-h-0 leading-relaxed max-w-full overflow-hidden break-words ${
                    msg.isError
