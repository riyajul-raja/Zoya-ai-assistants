            ...
            >
              ...
              <div className="opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity absolute right-2 top-1/2 -translate-y-1/2">
                <button
                  ...
                  className="chat-menu-trigger p-2 text-neutral-400 hover:text-white transition-all duration-200 opacity-60 hover:opacity-100 active:scale-95"
                >
                  ...
                  {activeMenuId === chat.id && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="chat-menu-dropdown absolute right-0 top-full mt-2 w-48 bg-[#1a0509] border border-red-500/30 shadow-[0_15px_50px_rgba(220,38,38,0.3)] rounded-2xl py-2 z-[100] overflow-hidden"
                      >
                        <motion.button 
