...
export default function CalendarManager({ onClose, isGhostMode = false, onToast }: CalendarManagerProps) {
  ...
  const fetchEvents = async (accessToken: string, queryStr = "") => {
    ...
    try {
      ...
      let url = `https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=${encodeURIComponent(timeMin)}&singleEvents=true&orderBy=startTime&maxResults=30`;
