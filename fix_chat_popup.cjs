...
content = content.replace("import React, { useRef, useEffect } from 'react';", "import React, { useRef, useEffect, useState } from 'react';");

// 2. Add local state to ChatPage
